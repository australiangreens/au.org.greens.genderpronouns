...
function _pronouns_civix_mixin_polyfill() {
...
function _pronouns_civix_civicrm_config($config = NULL) {
  ...
  _pronouns_civix_mixin_polyfill();
}
 ...
 */
function _pronouns_civix_civicrm_enable(): void {
  _pronouns_civix_civicrm_config();
  _pronouns_civix_mixin_polyfill();
}
  ...
  if (empty($path)) {
    ...
    foreach ($menu as $key => &$entry) {
      if ($entry['attributes']['name'] == $first) {
        ...
        $found = _pronouns_civix_insert_navigation_menu($entry['child'], implode('/', $path), $item);
      }
    }
    return $found;
  }
